...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return <ErrorFallback errorMessage={this.state.errorMessage} errorStack={this.state.errorStack} />;
    }
 ...
 */
function ErrorFallback({ errorMessage, errorStack }: { errorMessage: string; errorStack: string }) {
  return (
