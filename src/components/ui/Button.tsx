...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:shadow-lg hover:scale-105 focus:ring-purple-500',
      secondary:
        'bg-white text-purple-600 border-2 border-purple-500 hover:bg-purple-50 focus:ring-purple-500',
      outline:
