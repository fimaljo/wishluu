...
export function ColorPicker({ 
  ...
  const predefinedColors = [
    // Warm Colors
    '#FF6B6B', '#FF8E8E', '#FFB3B3', '#FFD8D8',
    '#FF9F43', '#FFB366', '#FFC789', '#FFDBAC',
    '#FECA57', '#FFD580', '#FFE0A3', '#FFEBC6',
    '#FF9FF3', '#FFB3F7', '#FFC7FB', '#FFDBFF',
    
    // Cool Colors
    '#48DB71', '#6BE08A', '#8EE5A3', '#B1EABC',
    '#54A0FF', '#77B3FF', '#9AC6FF', '#BDD9FF',
    '#5F27CD', '#8254D4', '#A581DB', '#C8AEE2',
    '#00D2D3', '#33DBDC', '#66E4E5', '#99EDEE',
    
    // Neutral Colors
    '#C8D6E5', '#D1DCE8', '#DAE2EB', '#E3E8EE',
    '#8395A7', '#96A5B5', '#A9B5C3', '#BCC5D1',
    '#576574', '#6A7482', '#7D8390', '#90929E',
    '#2F3542', '#424A5A', '#555F72', '#68748A',
