            ...
            <div className="space-y-6">
              ...
              <div className="flex space-x-3">
                <Button
                  variant="primary"
                  onClick={handleSave}
                  disabled={isSaving || !recipientName.trim() || !message.trim()}
                  className="flex-1"
                >
              ...
              {shareUrl ? (
                <>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium text-gray-900 mb-1">Preview Your Wish</h4>
                        <p className="text-sm text-gray-600">See how your wish will look to others</p>
                      </div>
                      <Button
                        variant="primary"
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Save Your Wish First</h3>
