    ...
    <div className={`relative ${className}`}>
      ...
      <div className='absolute inset-0 bg-white/90 backdrop-blur-[0.5px] rounded-lg z-10 flex items-center justify-center min-h-[120px]'>
        <div className='text-center p-4'>
          ...
          <div className='text-xs text-gray-500 mb-3'>{upgradeMessage}</div>
          <button
...
export function PremiumBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-medium rounded-full ${className}`}
    >
      <span>✨</span>
      {label}
    </span>
