...
export function BeautifulText({
  ...
  const getSpecialEffects = (fontType: string) => {
    const effects = {
      ...
      bangers: {
        textShadow:
          '3px 3px 0px rgba(0,0,0,0.2), -1px -1px 2px rgba(255,255,255,0.9)',
        letterSpacing: '1px',
      },
      righteous: {
      ...
      bubblegum: {
        textShadow:
          '1px 1px 2px rgba(0,0,0,0.1), -1px -1px 1px rgba(255,255,255,0.7)',
        letterSpacing: '0.2px',
      },
      comic: {
  ...
  return (
    <div
      ...
      style={{
        padding: `${padding}px`,
        fontFamily:
          fontFamilies[titleFont as keyof typeof fontFamilies] ||
    ...
    >
      ...
      <p
        ...
        style={{
          ...
          fontFamily:
            fontFamilies[messageFont as keyof typeof fontFamilies] ||
            fontFamilies.inter,
