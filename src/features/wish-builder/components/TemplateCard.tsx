...
export function TemplateCard({
  ...
  return (
    ...
    >
      {/* Template Preview */}
      <div
        className={`bg-gradient-to-r ${template.color} p-6 text-white text-center relative overflow-hidden`}
      >
        <div className='text-6xl mb-4'>{template.thumbnail}</div>

        {/* Difficulty Badge */}
        <div
          className={`absolute top-4 right-4 px-2 py-1 rounded-full text-xs font-medium ${difficultyColors[template.difficulty]}`}
        >
